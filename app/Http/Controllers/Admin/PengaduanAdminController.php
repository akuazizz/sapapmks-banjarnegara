...
class PengaduanAdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        $statuses = ['Semua Status', 'Diterima', 'Diversifikasi', 'Diproses', 'Selesai', 'Ditolak'];
    ...
    public function edit(Pengaduan $pengaduan)
    {
        ...
        $statuses = ['Diterima', 'Diversifikasi', 'Diproses', 'Selesai', 'Ditolak'];
    ...
    public function update(Request $request, Pengaduan $pengaduan)
    {
        // 1. Validasi Dasar
        $rules = [
            'status' => 'required|in:Diterima,Diversifikasi,Diproses,Selesai,Ditolak',
