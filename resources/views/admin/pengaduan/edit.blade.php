...
<div class="flex items-center justify-center p-4">
    <div class="bg-white p-8 rounded-xl shadow-2xl w-full max-w-lg mx-auto border-4 border-gray-100 relative">
        ...
        <div class="space-y-4 mb-8 text-gray-700">
            ...
            <div class="grid grid-cols-3">
                ...
                <span class="col-span-2">: {{ \Carbon\Carbon::parse($pengaduan->tanggal_laporan)->translatedFormat('d/m/Y') }}</span>
            </div>
